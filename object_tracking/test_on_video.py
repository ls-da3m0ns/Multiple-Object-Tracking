...
if __name__ == '__main__':
	...
	filename = '/gdrive/MyDrive/car_tracking/det20.txt'
	gt_dict = get_dict(filename)
	
	tmp_cap = cv2.VideoCapture('/gdrive/MyDrive/car_tracking/vid14.mp4')
	tmp_shape = tmp_cap.read()[1].shape 

	cap = cv2.VideoCapture('/gdrive/MyDrive/car_tracking/vid14.mp4')
	...
	out = cv2.VideoWriter('vid14_0out.mp4',fourcc, 15.0, (tmp_shape[1],tmp_shape[0]))
